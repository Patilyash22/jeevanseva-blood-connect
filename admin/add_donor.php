...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO donors (name, email, phone, blood_group, location, age, weight, last_donation_date, medical_conditions, status) 
                VALUES ('$name', '$email', '$phone', '$blood_group', '$location', $age, $weight, $last_donation_sql, '$medical_conditions', '$status')";
    ...
    <div class="card-body">
        ...
        <form method="POST" class="admin-form">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" id="age" name="age" min="18" value="<?php echo isset($_POST['age']) ? $_POST['age'] : ''; ?>" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" id="weight" name="weight" min="50" value="<?php echo isset($_POST['weight']) ? $_POST['weight'] : ''; ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="location" name="location" placeholder="City, State" value="<?php echo isset($_POST['location']) ? $_POST['location'] : ''; ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="medical_conditions" name="medical_conditions" rows="3"><?php echo isset($_POST['medical_conditions']) ? $_POST['medical_conditions'] : ''; ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" required>
                    ...
                    <option value="pending" <?php echo (isset($_POST['status']) && $_POST['status'] === 'pending') ? 'selected' : 'selected'; ?>>Pending</option>
                </select>
            </div>
